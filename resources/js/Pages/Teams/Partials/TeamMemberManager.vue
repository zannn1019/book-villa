                        ...
                        <div v-for="invitation in team.team_invitations" :key="invitation.id"
                            ...
                            <div class="flex items-center">
                                ...
                                <button v-if="userPermissions.canRemoveTeamMembers"
                                    class="cursor-pointer ms-6 text-sm text-green-500 focus:outline-none"
                        ...
                        <div v-for="user in team.users" :key="user.id" class="flex items-center justify-between">
                            ...
                            <div class="flex items-center">
                                ...
                                <button v-if="$page.props.auth.user.id === user.id"
                                    class="cursor-pointer ms-6 text-sm text-green-500" @click="confirmLeavingTeam">
                                    Leave
                                </button>

                                <!-- Remove Team Member -->
                                <button v-else-if="userPermissions.canRemoveTeamMembers"
                                    class="cursor-pointer ms-6 text-sm text-green-500"
